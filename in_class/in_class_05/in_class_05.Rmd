...
# Write the answer in a comment
# Q: Which state has the highest average number of cases per county in our data?
# A: Arizona
```
...
A: New Jersey had the highest average number of deaths per county at 758.90 deaths.
```{r}
...
A: Alaska had the lowest average number of deaths per county at 1.30 average deaths per county.
