...
# A: Prince George's County with 29.272723 cases per 1000.
...
# A: Greensville County with 60.554 cases per 1000.
...
# A: Two counties in the U.S. had a death rate abover 4 per 1,000 in Auguest. They were Hancock, GA and Galax City, VA.
...
# A: Kent, MD had a death rate higher than 1 per 1,000 in August.
...
# A: Galax City, Emporia City, and Northampton are all VA areas that had a death rate higher than 2 per 1,000 in August.
...
# A: Lafayette County, FL, had the biggest jump in cumulative case rate between July and August.
...
# A: Luce, Michigan, had the biggest percentage jump in cumulative case rate.
...
covid_county_maryland_death_pctchange_june_august <- covid_county_monthly_death_rate %>%
  select(county, state, d_2020_06_30, d_2020_07_30, d_2020_08_30) %>%
...
covid_county_maryland_death_pctchange_june_august

# Q: which Maryland county had the largest percentage change in cumulative death rate between June and August? 
# A: write the answer here: Queen Anne's County, MD had the largest percentage change in cumulative death rate between June and August.
...
```{r}
#which Texas county had the smallest percentage change in cumulative case rate between May and August?

#Write code below.

covid_county_texas_case_pctchange_may_august <- covid_county_monthly_case_rate %>%
...
#Write name of new object below.
covid_county_texas_case_pctchange_may_august

#Answer: 
#Jones, Texas, had the smallest percent change in cumulative case rate between May and August.
```
...
```{r}
#Question: Which Alaska county had the largest percent change in cumulative death rate between June and August?

#Code:

covid_county_alaska_death_pctchange_june_august <- covid_county_monthly_death_rate %>%
...
covid_county_alaska_death_pctchange_june_august

#Answer: Fairbanks North Star Borough had the largest percent change in cumulative death rate between June and August.
